...
#include </opt/local/include/boost/archive/detail/decl.hpp>
...
#include </opt/local/include/boost/archive/detail/abi_prefix.hpp> // must be the last header
...
#include </opt/local/include/boost/archive/detail/abi_suffix.hpp> // pops abi_suffix.hpp pragmas

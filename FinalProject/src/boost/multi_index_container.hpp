...
#include <algorithm>
#include </opt/local/include/boost/detail/allocator_utilities.hpp>
#include </opt/local/include/boost/detail/no_exceptions_support.hpp>
#include </opt/local/include/boost/detail/workaround.hpp>
#include </opt/local/include/boost/move/core.hpp>
#include </opt/local/include/boost/mpl/at.hpp>
#include </opt/local/include/boost/mpl/contains.hpp>
#include </opt/local/include/boost/mpl/find_if.hpp>
#include </opt/local/include/boost/mpl/identity.hpp>
#include </opt/local/include/boost/mpl/int.hpp>
#include </opt/local/include/boost/mpl/size.hpp>
#include </opt/local/include/boost/mpl/deref.hpp>
#include </opt/local/include/boost/multi_index_container_fwd.hpp>
#include </opt/local/include/boost/multi_index/detail/access_specifier.hpp>
#include </opt/local/include/boost/multi_index/detail/adl_swap.hpp>
#include </opt/local/include/boost/multi_index/detail/base_type.hpp>
#include <b/opt/local/include/oost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include </opt/local/include/boost/multi_index/detail/converter.hpp>
#include <boost/multi_index/detail/header_holder.hpp>
#include </opt/local/include/boost/multi_index/detail/has_tag.hpp>
#include </opt/local/include/boost/multi_index/detail/no_duplicate_tags.hpp>
#include </opt/local/include/boost/multi_index/detail/safe_mode.hpp>
#include </opt/local/include/boost/multi_index/detail/scope_guard.hpp>
#include </opt/local/include/boost/multi_index/detail/vartempl_support.hpp>
#include </opt/local/include/boost/static_assert.hpp>
#include </opt/local/include/boost/type_traits/is_same.hpp>
#include </opt/local/include/boost/utility/base_from_member.hpp>

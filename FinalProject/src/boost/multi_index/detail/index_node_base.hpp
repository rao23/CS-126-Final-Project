...
#include </opt/local/include/boost/type_traits/aligned_storage.hpp>
#include </opt/local/include/boost/type_traits/alignment_of.hpp>

#if !defined(BOOST_MULTI_INDEX_DISABLE_SERIALIZATION)
#include </opt/local/include/boost/archive/archive_exception.hpp>
#include </opt/local/include/boost/serialization/access.hpp>
...
#include </opt/local/include/boost/multi_index/detail/ignore_wstrict_aliasing.hpp>
...
#include </opt/local/include/boost/multi_index/detail/restore_wstrict_aliasing.hpp>

...
#include </opt/local/include/boost/config.hpp> /* keep it first to prevent nasty warns in MSVC */
...
#include </opt/local/include/boost/move/utility.hpp>
#include </opt/local/include/boost/mpl/vector.hpp>
#include </opt/local/include/boost/multi_index/detail/copy_map.hpp>
#include </opt/local/include/boost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include </opt/local/include/boost/multi_index/detail/node_type.hpp>
...
#include </opt/local/include/boost/multi_index/detail/index_loader.hpp>
#include </opt/local/include/boost/multi_index/detail/index_saver.hpp>
#endif

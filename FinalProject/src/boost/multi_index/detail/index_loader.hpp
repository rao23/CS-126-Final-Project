...
#include </opt/local/include/boost/noncopyable.hpp>
#include </opt/local/include/boost/multi_index/detail/auto_space.hpp>
#include </opt/local/include/boost/multi_index/detail/raw_ptr.hpp>
#include </opt/local/include/boost/serialization/nvp.hpp>

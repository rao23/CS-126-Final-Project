...
#include </opt/local/include/boost/mpl/transform.hpp>
#include </opt/local/include/boost/mpl/vector.hpp>
#include </opt/local/include/boost/preprocessor/facilities/intercept.hpp>
#include </opt/local/include/boost/preprocessor/repetition/enum_binary_params.hpp>
#include </opt/local/include/boost/preprocessor/repetition/enum_params.hpp>

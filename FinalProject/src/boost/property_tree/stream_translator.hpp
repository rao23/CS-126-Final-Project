...
#include </opt/local/include/boost/optional/optional_io.hpp>
#include </opt/local/include/boost/utility/enable_if.hpp>
#include </opt/local/include/boost/type_traits/decay.hpp>
#include </opt/local/include/boost/type_traits/integral_constant.hpp>
#include <sstream>
#include <string>
#include <locale>
#include <limits>
